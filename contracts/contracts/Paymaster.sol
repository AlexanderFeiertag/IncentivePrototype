...
contract Paymaster is IPaymaster, Ownable {
    ...
    constructor(address _employeeStorageAddress) {
        ...
        returns (bytes4 magic, bytes memory context)
    {
        ...
        // Costum validations
        (address employeeAddress, , , ) = employeeStorage.getEmployee(address(uint160(_transaction.from)));
        require(employeeAddress != address(0), "Paymaster only pays for known employees");
